...
class __TwigTemplate_701aca3768a8c7f60249705bf6d2786138a02615d0e3917f5eafe997441c9045 extends Twig_Template
{
...
<div class=\"mj-container\" style=\"background-color:#FFFFFF; direction:";
    ...
    <div style=\"margin:0px auto;max-width:600px;background:#ECECEC;\">
        ...
        // line 120
        echo sprintf(call_user_func_array($this->env->getFunction('T')->getCallable(), array("activation.yourRegistrationOn")), ($context["WORLD_ID"] ?? null));
        echo "</span>
                                        </h1></div>
                                </td>
                            </tr>
        ...
        // line 129
        echo sprintf(call_user_func_array($this->env->getFunction('T')->getCallable(), array("activation.hello")), ($context["PLAYER_NAME"] ?? null));
        echo "</span>
                                        </p>
                                        <p>
                                            <span style=\"font-size:16px;\">";
        // line 132
        echo sprintf(call_user_func_array($this->env->getFunction('T')->getCallable(), array("activation.thankYouForRegisteringOn")), ($context["WORLD_ID"] ?? null));
        echo "</span>
                                        </p>
                                        <p>
                                            <span style=\"font-size:16px;\">";
        ...
        // line 138
        echo sprintf(call_user_func_array($this->env->getFunction('T')->getCallable(), array("activation.activationCode")), ($context["ACTIVATION_CODE"] ?? null));
        echo "</span>
                                        </p></div>
                                </td>
                            </tr>
                                        ...
                                        <tr>
                                            <td style=\"border:none;border-radius:24px;color:#fff;cursor:auto;padding:10px 25px;\"
                                                align=\"center\" valign=\"middle\" bgcolor=\"#6FDB59\"><a
                                                        href=\"";
        // line 151
        echo twig_escape_filter($this->env, ($context["ACTIVATE_URL"] ?? null), "html", null, true);
        echo "\"
    ...
    {
        return new Twig_Source("", "mail/activation.twig", "/home/runner/workspace/sections/api/include/Templates/mail/activation.twig");
    }
}
